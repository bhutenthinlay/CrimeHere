...
public class StickyListHeadersActivity extends Fragment {
	...
	static StickyListHeadersListView listView;
	public static  MyStickyListHeadersAdapter adapter;

	double top,bottom,left,right;
	StickyListHeadersActivity(double bottom,double top,double left,double right)
	{
		this.bottom=bottom;
		this.top=top;
		this.left=left;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		inflater.inflate(R.layout.activity_stickylistheaders, wrapper, true);
		 listView = (StickyListHeadersListView)wrapper.findViewById(R.id.activity_stickylistheaders_listview);
		...
		listView.setFitsSystemWindows(true);
		 ...
		 adapter = new MyStickyListHeadersAdapter(
				super.getActivity(),GoogleMapFragment.mylist);
		 init();
	...
	public static StickyListHeadersActivity newInstance(double bottom,double top,double left,double right) {
		StickyListHeadersActivity fragment = new StickyListHeadersActivity(bottom, top, left, right);
